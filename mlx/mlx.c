...
/*   Updated: 2023/05/20 21:46:39 by ndesprez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	instance->img.floor = xpm_img(instance, "./xpm/icons/floor.xpm");
	instance->img.player = xpm_img(instance, "./xpm/icons/player.xpm");
	instance->img.wall = xpm_img(instance, "./xpm/icons/wall.xpm");
	instance->img.item = xpm_img(instance, "./xpm/icons/item.xpm");
	instance->img.exit = xpm_img(instance, "./xpm/icons/exit.xpm");
}
